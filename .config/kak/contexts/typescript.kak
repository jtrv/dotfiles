...
map window object a     -docstring 'LSP any symbol'                    %{<a-;>: lsp-object <ret>}
map window object e     -docstring 'LSP function or method'            %{<a-;>: lsp-object Function Method <ret>}
map window object k     -docstring 'LSP class interface or struct'     %{<a-;>: lsp-object Class Interface Struct <ret>}
