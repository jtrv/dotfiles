...
- **Independent adversarial review:** fresh agent told to hunt defects, findings
  back to the implementer, re-review; ~3 rounds. Cross-model plan refutation is
  the `plan-refute` skill.
